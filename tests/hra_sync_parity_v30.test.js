...
for (const name of [
  ...
  assert(html.includes('gascheck-core.js?v=34-period-photo-contrast'), `${name} must bust the old shared-core cache`);
}

assert(core.includes("GC.version = '3.1-period-photo-contrast'"));
