...
assert(temp.includes("tempTgTable(['Date','Zone','Slot','Weather','Inspector']"));
assert(temp.includes("'Area Key'"));
...
console.log('v47 SEC-style Telegram formatting checks passed');
